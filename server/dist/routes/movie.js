...
movieRoutes.get('/', (req, res, next) => _security.authenticate(req, res, next), (req, res, next) => _controller.getMoviesList(req, res, next), (req, res, next) => _baseController.send(req, res, next));
movieRoutes.get('/:range([0-9]{10},[0-9]{10})', (req, res, next) => _security.authenticate(req, res, next), (req, res, next) => _controller.getMoviesList(req, res, next), (req, res, next) => _baseController.send(req, res, next));
movieRoutes.get('/:username([0-9a-zA-z]+)', (req, res, next) => _security.authenticate(req, res, next), (req, res, next) => _controller.getMoviesList(req, res, next), (req, res, next) => _baseController.send(req, res, next));
