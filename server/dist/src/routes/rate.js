...
// Route that decides what type of rating to make based on the action made 
userRoutes.post('/movie', (req, res, next) => _security.authenticate(req, res, next), (req, res, next) => _controller.rateMovie(req, res, next), (req, res, next) => _baseController.send(req, res, next));
