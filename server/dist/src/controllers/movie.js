...
class MovieController {
    ...
    getMoviesMeta(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const metaResults = yield this._service.getMoviesMeta(req.baseUrl, responseData.data.length, params, query);
            if (!metaResults)
                return next();
            const final = Object.assign(Object.assign({}, response), { meta: metaResults });
            res.response = final;
            next();
        });
    }
